...
const UpdateCoffee = () => {
    const { _id, name, quantity, taste, category, details, photo, price } = useLoaderData();
    ...
    const handleUpdateCoffee = e => {
        ...
        fetch(`coffee-store-server-rho-six.vercel.app/coffees/${_id}`, {
            method: 'PUT',
            headers: {
    ...
    return (
        <div className='p-24 bg-[#F4F3F0]'>
            <div className='p-12 text-center'>
                <h1 className='text-6xl mb-6'>Update Coffee</h1>
            ...
            <form onSubmit={handleUpdateCoffee}>
                ...
                <input type="submit"  className='btn w-full bg-[#D2B48C] border border-yellow-950' value="Update Coffee" />
            </form>
        </div>
    );
};
