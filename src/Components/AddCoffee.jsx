...
const AddCoffee = () => {
    const handleAddCoffee = e => {
        ...
        //send coffee to the DB
        fetch('coffee-store-server-rho-six.vercel.app/coffees', {
            method: 'POST',
            headers: {
    ...
    return (
        <div className='p-24 bg-[#F4F3F0]'>
            <div className='p-12 text-center'>
                <h1 className='text-6xl mb-6'>Add Coffee</h1>
            ...
            <form onSubmit={handleAddCoffee}>
                ...
                <input type="submit" className='btn w-full bg-[#D2B48C] border border-yellow-950' value="Add Coffee" />
            </form>
        </div>
    );
};
